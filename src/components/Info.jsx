...
const Disclosure = ({ id, title, children }) => {
  ...
  return (
    <details className="bg-gray-700 rounded-lg group" onToggle={onToggle}>
      <summary
        id={`${id}-summary`}
        className="flex justify-between items-center cursor-pointer p-4 font-bold text-lg text-cyan-300 rounded-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-300"
      ...
      <div
        ...
        className="prose prose-invert max-w-none text-gray-300 p-4 border-t border-gray-600 rounded-b-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-300"
      >
        {children}
      </div>
    </details>
...
const Info = () => (
  <div className="mt-12 pt-8 border-t border-gray-700 space-y-4">
    <Disclosure id="bronze" title="What's Covered by the Bronze Level?">
        ...
        <ul className="list-disc list-inside">
          ...
          <li><strong>Lc 30 Minimum:</strong> The absolute minimum for any discernible text, such as disabled or
            placeholder text.</li>
          <li><strong>Reference:</strong> Review Bronze simple mode guidance on the <a href="https://www.readtech.org/ARC/tests/bronze-simple-mode/" target="_blank"
            rel="noopener" className="text-cyan-300 underline underline-offset-2 decoration-cyan-200 hover:text-cyan-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-300 rounded">ARC Bronze test page</a>.</li>
        </ul>
    </Disclosure>

    <Disclosure id="silver" title="What's Covered by the Silver Level?">
        ...
        <ul className="list-disc list-inside">
          ...
          <li><strong>Uses Lookup Tables:</strong> Required Lc value is determined by the font size and weight. See
            the official <a href="https://www.readtech.org/ARC/tests/visual-readability-contrast/" target="_blank"
              rel="noopener" className="text-cyan-300 underline underline-offset-2 decoration-cyan-200 hover:text-cyan-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-300 rounded">APCA Lookup Tables</a>.</li>
          <li><strong>Minimum Font Size:</strong> Recommends a minimum of 13px for content text.</li>
        </ul>
    </Disclosure>

    <Disclosure id="gold" title="What's Covered by the Gold Level?">
        ...
        <ul className="list-disc list-inside">
          <li><strong>Higher Lc Values:</strong> Requires higher contrast values than Silver for the same font size
            and weight, based on the same <a href="https://www.readtech.org/ARC/tests/visual-readability-contrast/"
              target="_blank" rel="noopener" className="text-cyan-300 underline underline-offset-2 decoration-cyan-200 hover:text-cyan-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-300 rounded">lookup tables</a>.</li>
    ...
    <p className="text-center text-gray-400 pt-4">
      For detailed information, visit the <a href="https://apcacontrast.com/" target="_blank" rel="noopener"
        className="text-cyan-300 underline underline-offset-2 decoration-cyan-200 hover:text-cyan-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-300 rounded">official APCA website</a>.
    </p>
  </div>
);
