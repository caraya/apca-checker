...
const Preview = ({ textColor, bgColor, fontSize, fontWeight, contrast, children }) => {
  ...
  return (
    <div
      ...
      style={previewStyle}
    >
      <div className="absolute top-4 right-4 text-sm bg-black bg-opacity-20 px-2 py-1 rounded-md">
      ...
      <div className="mt-8">
        <h2 className="text-4xl font-bold" style={h2Style}>Sample Heading</h2>
